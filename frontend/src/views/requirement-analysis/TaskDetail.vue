...
.export-btn:disabled {
  ...
  color: var(--th-text-disabled, #ccc);
  cursor: not-allowed;
}
...
.batch-adopt-btn:disabled,
.batch-discard-btn:disabled {
  background: var(--th-bg-tertiary, #f5f5f5);
  border-color: var(--th-border, #e5e5e5);
  color: var(--th-text-disabled, #ccc);
  cursor: not-allowed;
...
.table-body .table-row {
  ...
  grid-template-columns: 60px 120px 1fr 1fr 1fr 1fr 80px 150px;
  border-bottom: 1px solid var(--th-border, #e5e5e5);
  transition: background var(--th-transition-base, 0.2s ease);
}
...
.modal-footer {
  ...
  background: var(--th-bg-secondary, #fafafa);
  border-radius: 0 0 var(--th-radius-xl, 12px) var(--th-radius-xl, 12px);
}
