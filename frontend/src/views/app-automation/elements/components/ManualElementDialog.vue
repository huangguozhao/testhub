  ...
  >
    <el-form :model="formData" ref="formRef" label-width="120px" :rules="rules">
      ...
      <el-form-item label="标签">
        ...
        <div style="color: #909399; font-size: 12px; margin-top: 5px; display: flex; align-items: flex-start; gap: 4px;">
      ...
      <template v-if="formData.element_type === 'image'">
        ...
        <el-form-item label="元素图片">
          ...
          <div v-if="isEdit && formData.config.image_path" class="current-image-section">
            <div style="color: #606266; font-size: 14px; margin-bottom: 10px; font-weight: 500; display: flex; align-items: center; gap: 4px;">
            ...
            <div v-if="showUpload && imagePreview" style="margin-top: 15px">
              ...
              <div style="color: #67C23A; font-size: 12px; margin-top: 8px; display: flex; align-items: flex-start; gap: 4px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0; margin-top: 1px;"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0018 8 6 6 0 006 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 018.91 14"/></svg>
                保存后将替换当前图片
              </div>
            </div>
