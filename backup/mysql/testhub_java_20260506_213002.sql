...
INSERT INTO `api_environment` VALUES (1,7,'TestEnv','Test environment','LOCAL','{\"baseUrl\": \"https://httpbin.org\"}',1,0,0,'2026-04-30 09:49:30','2026-04-30 09:49:30',4,4),(2,NULL,'test1',NULL,'GLOBAL','{\"test2\": {\"currentValue\": \"test4\", \"initialValue\": \"test3\"}}',0,0,0,'2026-05-06 21:20:41','2026-05-06 21:20:41',2,2),(3,NULL,'test1 - Copy',NULL,'GLOBAL','{\"test2\": {\"currentValue\": \"test4\", \"initialValue\": \"test3\"}}',0,0,1,'2026-05-06 21:21:01','2026-05-06 21:21:05',2,2);
...
CREATE TABLE `api_request_history` (
  ...
  KEY `idx_suite_id` (`suite_id`) USING BTREE,
  KEY `idx_executed_at` (`executed_at`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='API璇锋眰鍘嗗彶琛?;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='Token榛戝悕鍗曡〃';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-06 13:30:03
