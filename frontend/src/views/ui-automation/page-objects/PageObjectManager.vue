...
.left-panel {
  width: 350px;
  border-right: 1px solid var(--th-border, #e5e5e5);
  display: flex;
  flex-direction: column;
}
...
.page-object-item:hover {
  border-color: var(--th-primary, #409eff);
  box-shadow: 0 2px 8px rgba(64, 158, 255, 0.2);
}

.page-object-item.active {
  border-color: var(--th-primary, #409eff);
  background-color: var(--th-primary-light, #f0f8ff);
}
...
.class-name {
  ...
  background-color: var(--th-bg-tertiary, #f5f5f5);
  padding: 2px 6px;
  border-radius: var(--th-radius-sm, 3px);
...
.canvas-drop-zone {
  min-height: 300px;
  border: 2px dashed var(--th-text-disabled, #ccc);
  border-radius: var(--th-radius-md, 6px);
  padding: 20px;
}
