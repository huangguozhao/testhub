...
CREATE TABLE `api_request_history` (
  ...
  KEY `idx_suite_id` (`suite_id`) USING BTREE,
  KEY `idx_executed_at` (`executed_at`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='API璇锋眰鍘嗗彶琛?;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='Token榛戝悕鍗曡〃';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-06  1:30:07
