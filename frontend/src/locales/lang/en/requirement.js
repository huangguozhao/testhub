export default {
  requirementAnalysis: {
    ...
    testCaseCountAuto: 'Auto (AI decides)',
    testCaseCountApprox: '~',
    testCaseCountUnit: '',
    ...
    generatingTestCases: 'Writing test cases...',
    ...
    // Stream Display
    realtimeGeneratedContent: 'Real-time Generated Content',
  ...
  generationConfig: {
    // Page
    title: 'Generation Behavior Config',
    ...
    // Timeout
    timeoutSettingsLabel: 'Timeout Settings',
